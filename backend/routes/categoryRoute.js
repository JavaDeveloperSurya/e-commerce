...
const {createCategory,getAllCategories,getSingleCategory,updateCategory,deleteCategory,getAllCategoriesForAdmin} = require('../controllers/categoryController');


router.get('/categories', getAllCategories);
router.get('/category/:id', getSingleCategory);
router.get('/categories/all', authenticate, adminAuth, getAllCategoriesForAdmin);
